...
examples = pd.read_csv('Dataset/fewshot_examples.csv') # Use your own path
...
def fewshot_prediction(test_data, manip_examples, nonmanip_examples):
    ...
    test_data.to_csv('Dataset/fewshot_prediction_gpt-4-1106-preview.csv', index=False) # Use your own path
